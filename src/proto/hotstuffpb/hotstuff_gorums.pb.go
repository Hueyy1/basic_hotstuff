...
func (m *Manager) NewConfiguration(opts ...gorums.ConfigOption) (c *Configuration, err error) {
	...
	for _, opt := range opts {
		...
		case QuorumSpec:
			...
			c.qspec = v
		default:
			return nil, fmt.Errorf("config: unknown option types: %v", v)
		}
	}
	// return an error if the QuorumSpec interface is not empty and no implementation was provided.
	var test any = struct{}{}
...
// HotstuffClient is the client interface for the Hotstuff service.
type HotstuffClient interface {
	...
	Fetch(ctx context.Context, in *BlockHash) (resp *Block, err error)
}

// enforce interface compliance
var _ HotstuffClient = (*Configuration)(nil)

// HotstuffNodeClient is the single node client interface for the Hotstuff service.
type HotstuffNodeClient interface {
...
// enforce interface compliance
var _ HotstuffNodeClient = (*Node)(nil)
